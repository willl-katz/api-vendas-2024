...
describe('InMemoryRepository unit tests', () => {
  ...
  describe('applyFilter', () => {
    it('should no filter items when filter param is null', async () => {
      ...
      // Método usado para criar um "espião" em um método de um objeto.
      // Um espião permite que você registre chamadas a uma função e
      // suas respectivas entradas e saídas, possibilitando verificar
      // se a função foi chamada corretamente durante o teste.
  ...
  describe('applyPaginate', () => {
    it('should paginate items', async () => {
      const items = [
        ...
        { id: randomUUID(), name: 'c', price: 30, created_at, updated_at },
        { id: randomUUID(), name: 'd', price: 40, created_at, updated_at },
        { id: randomUUID(), name: 'e', price: 50, created_at, updated_at },
      ]
  ...
  describe('search', () => {
    ...
    it('should apply paginate and sort', async () => {
      const items = [
        ...
        { id: randomUUID(), name: 'c', price: 40, created_at, updated_at },
